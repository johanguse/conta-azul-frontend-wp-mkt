					...
					<div class="container">
						<div class="row">
							<div class=" mb-4 offset-0 offset-xl-3 offset-lg-2 col-xl-3 col-lg-4 col-md-6">
								<button type="submit" class="btn btn-outline-primary" onclick="gtag('event', 'click', {'event_category' : 'Página de Eventos', 'event_label' : 'Click Compartilhar'});">
